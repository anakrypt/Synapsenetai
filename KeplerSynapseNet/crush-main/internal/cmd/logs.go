...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View synapseide logs",
	Long:  `View the logs generated by SynapseIDE. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Options.DataDirectory, "logs", "synapseide.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("No synapseide logs found for this project/data dir.")
			return nil
		}
