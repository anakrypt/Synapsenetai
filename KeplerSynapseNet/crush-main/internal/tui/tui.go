...
func (a *appModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case app.UpdateAvailableMsg:
		...
		statusMsg := fmt.Sprintf("SynapseIDE update available: v%s → v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			statusMsg = fmt.Sprintf("This is a development version of SynapseIDE. The latest version is v%s.", msg.LatestVersion)
		}
