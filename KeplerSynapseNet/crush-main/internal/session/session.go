...
type Service interface {
	...
	CreateThreadSession(ctx context.Context, parentSessionID, title string) (Session, error)
...
func (s *service) CreateThreadSession(ctx context.Context, parentSessionID, title string) (Session, error) {
	params := db.CreateSessionParams{
		ID:    uuid.New().String(),
		Title: title,
	}
	if parentSessionID != "" {
		params.ParentSessionID = sql.NullString{String: parentSessionID, Valid: true}
	}
